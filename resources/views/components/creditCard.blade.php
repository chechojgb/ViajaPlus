<div class="p-6 h-1 shadow-md items-center bg-gray-50">
    <!-- Image -->

    <!-- Text and link -->
    <div class="flex justify-center bg-gray-50 rounded-lg shadow-md p-4 flex items-center space-x-4">

        <div >
            <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 368" width="300" height="184">
                <defs>
                  <mask id="chipMask">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-800">More options for your trip</h2>
            <p class="text-sm text-gray-600">Accumulate <span class="font-semibold">ViajaPLus Pass Miles</span> and <span class="font-semibold">Qualifying Points</span></p>
        </div>
    </div>
<div>
